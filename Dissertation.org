...
second one can be used to insert the trace file in a relationa
...
\begin{tabularx}{\linewidth}{lXXX}\toprule
                         &   {\bf Luiza}         & {\bf Orion1}         & {\bf Guarani}    \\\toprule
Inital heap size (bytes)         &  268435456        & 526368896            & 327213824   \\
Maximum heap size(bytes)        &  4294967296            & 8422162432        & 5236588544       \\
\bottomrule\end{tabularx}
\end{table}
#+END_LaTeX
