...
time unit is seconds. We considered the standard error to be
three standard deviations divided by the square root of the number of
experiments, which cover 99.7% of the cases
assuming a normal distribution \cite{normaldistribution}. We describe below
