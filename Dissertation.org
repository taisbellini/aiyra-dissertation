...
themselves. (PUT NEXT PARAGRAPH HERE) It is divided in two segments: event definition and
timestamped events, which will be detailed later in this
section. (MOVE THIS LAST PHRASE TO JUST BEFORE "Events Definition"
MARK, ADAPT IT ACCORDINGLY).
