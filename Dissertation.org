...
containers. The organization of the plugin's entry points is still
strongly based on the two plugins crated. There is room to make more
generic entrances that can comprehend as many scenarios as possible.
