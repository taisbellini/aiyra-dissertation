...
\chapter*{Acknoledgements} First of all, I would like to say thank you
 to my advisor, Lucas Mello Schnorr, for dedicating his time and
 attention to make this project a relevant contribution.

To my mother, Zaida Loureiro, for understanding the time I needed to finish this work and trying to
review it even without a deep knowledge of the language.
...
Tinha olhada por cima a conclusão ontem. Meus comentários alto nível:
- começar por remotivar rapidamente o problema que tu atacas
- lembrar que a tua solução resolve o problema, explicar como
mesmo paragrafo

- dizer as vantagens da tua solução em relação a abordagem existente (talvez repetitivo com a tua motivação no contexto do teu TCC)
- dizer as desvantagens da tua abordagem (mostra maturidade, deixar claro quais são os problemas)
- dizer como foi feita a avaliação da tua solução
- colocar em evidência o principal ou dois principais resultados
- falar sobre trabalhos futuros
...
containers. The organization of the plugin's entry points is still strongly
based on the plugins crated. There is room to make more generic entrances that can comprehend
...
also be interesting to shift the options handling regarding each
plugin to its proper class, instead of centralizing all in the
