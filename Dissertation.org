...
a specific format, the Pajé Trace File Format, and processes five types of
...
links, hardware counters and so on. As a base for the implementation of this
...
(=pj_dump=), that dumps to the standard output all
information regarding entities created throughout the simulation.
...
*Add here the document structure.* Something like "This document is
organized as follows. Chapter ...
