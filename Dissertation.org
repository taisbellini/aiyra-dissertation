...
_Comment_:
- Say that this "bad" performance was observed in some preliminary
  experimental trials you have done before conducting the rigorous
  performance evaluation of Chapter X.
- appliable => applicable
- An analysis of the performance =>  A performance analysis
- Remove Will, use _is_ (present tense) as previously recommended
