...
a specific format, the Pajé Trace File Format, and processes five
...
implementation of this proposal, the new generation of Pajé, PajeNG,
...
used tool of PajeNG is the Pajé Dump (=pj_dump=), that dumps to the
...
files that are in the Pajé Trace File Format, which is described below. 
